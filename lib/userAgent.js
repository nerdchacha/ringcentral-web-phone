        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, this.registerer.register({
                        requestDelegate: {
                            onAccept: function () {
                                _this.emit(events_2.Events.UserAgent.Registrerd);
                            },
                            // FIXME: Test this
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, this.registerer.unregister({
                        requestDelegate: {
                            onAccept: function () {
                                _this.emit(events_2.Events.UserAgent.Unregistrerd);
                            }
                        }
                    })];
                case 1:
...
function invite(number, options) {
    ...
    inviter.invite().then(function () { return _this.emit(events_2.Events.UserAgent.InviteSent); });
